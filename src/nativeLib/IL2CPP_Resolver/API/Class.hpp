...
namespace IL2CPP
{
    namespace Class
    {
        ...
        {
            return (Unity::il2cppFieldInfo*) il2cpp_class_get_fields ((Il2CppClass*)m_pClass, m_pIterator);
        }
        ...
        {
            return (Unity::il2cppMethodInfo*) il2cpp_class_get_methods ((Il2CppClass *) m_pClass, m_pIterator);
        }
        ...
        Unity::il2cppType* GetType(Unity::il2cppClass* m_pClass)
        {
            ...
            return (Unity::il2cppType*) il2cpp_class_get_type ((Il2CppClass *) m_pClass);
        }
        ...
        Unity::il2cppObject* GetSystemType(Unity::il2cppClass* m_pClass)
        {
            ...
            return (Unity::il2cppObject*) il2cpp_type_get_object ((const Il2CppType *) GetType(m_pClass));
        }
        ...
        Unity::il2cppClass* GetFromName(Unity::il2cppImage* m_pImage, const char* m_pNamespace, const char* m_pName)
        {
            ...
            return (Unity::il2cppClass*) il2cpp_class_from_name ((const Il2CppImage *) m_pImage, m_pNamespace, m_pName);
        }
        ...
        void FetchClasses(std::vector<Unity::il2cppClass*>* m_pVector, const char* m_pModuleName, const char* m_pNamespace)
        {
            ...
            if (m_pImage)
            {
                ...
                size_t m_sClassesCount =  il2cpp_image_get_class_count ((const Il2CppImage *) m_pImage);
                ...
                for (size_t i = 0U; m_sClassesCount > i; ++i)
                {
                    ...
                    Unity::il2cppClass* m_pClass = (Unity::il2cppClass*) il2cpp_image_get_class ((const Il2CppImage *) m_pImage, i);
                    if (m_pNamespace)
                    {
                        if (m_pNamespace[0] == '\0')
                        {
        ...
        namespace Utils
        {
            ...
            void SetStaticField(Unity::il2cppClass* m_pClass, const char* m_pMemberName, void* m_pValue) {
                ...
                Unity::il2cppFieldInfo* m_pField = (Unity::il2cppFieldInfo*) il2cpp_class_get_field_from_name( (Il2CppClass *) m_pClass, m_pMemberName);
                if (m_pField){
                    ...
                    il2cpp_field_static_set_value ((FieldInfo *) m_pField, m_pValue);
                }
            }
            ...
            void* GetStaticField(Unity::il2cppClass* m_pClass, const char* m_pMemberName) {
                ...
                if (m_pField){
                    ...
                    il2cpp_field_static_get_value ((FieldInfo *) m_pField, &m_pValue);
                }
            ...
            void* GetMethodPointer(Unity::il2cppClass* m_pClass, const char* m_pMethodName, int m_iArgs = -1)
            {
                ...
                Unity::il2cppMethodInfo* pMethod = (Unity::il2cppMethodInfo*) il2cpp_class_get_method_from_name ((Il2CppClass *) m_pClass, m_pMethodName, m_iArgs);
            ...
            const char* MethodGetParamName(Unity::il2cppMethodInfo* m_pMethodInfo, uint32_t index)
            {
                ...
                return  il2cpp_method_get_param_name ((const MethodInfo *) m_pMethodInfo,  index);
            }
            ...
            Unity::il2cppType* GetMethodParamType(Unity::il2cppMethodInfo* m_pMethodInfo, uint32_t index) {
                ...
                return (Unity::il2cppType*) il2cpp_method_get_param ((const MethodInfo *) m_pMethodInfo, index);
            }
            ...
            Unity::il2cppClass* ClassFromType(Unity::il2cppType * type)
            {
                ...
                return (Unity::il2cppClass*) il2cpp_class_from_il2cpp_type ((const Il2CppType *) type);
            }
    ...
    public:
        ...
        m_eClassPropType GetPropType(const char* m_pPropType)
        {
            ...
            Unity::il2cppFieldInfo* pField = (Unity::il2cppFieldInfo*) il2cpp_class_get_field_from_name ((Il2CppClass *)( m_Object.m_pClass), m_pPropType);
            if (pField)
            ...
            Unity::il2cppPropertyInfo* pProperty = (Unity::il2cppPropertyInfo*) il2cpp_class_get_property_from_name ((Il2CppClass *) (m_Object.m_pClass), m_pPropType);
            if (pProperty)
            ...
            Unity::il2cppMethodInfo* pMethod = (Unity::il2cppMethodInfo*) il2cpp_class_get_method_from_name ((Il2CppClass * )(m_Object.m_pClass), m_pPropType, -1);
            if (pMethod)
...
// #endif
        ...
        T GetPropertyValue(const char* m_pPropertyName)
        {
            ...
            Unity::il2cppPropertyInfo* pProperty = (Unity::il2cppPropertyInfo*) il2cpp_class_get_property_from_name ((Il2CppClass *) (m_Object.m_pClass), m_pPropertyName);
        ...
        T GetMemberValue(const char* m_pMemberName)
        {
            ...
            Unity::il2cppFieldInfo* pField = (Unity::il2cppFieldInfo*) il2cpp_class_get_field_from_name( (Il2CppClass *) (m_Object.m_pClass), m_pMemberName);
            if (pField)
            {
        ...
        T GetObscuredValue(const char* m_pMemberName)
        {
            ...
            Unity::il2cppFieldInfo* m_pField = (Unity::il2cppFieldInfo*) il2cpp_class_get_field_from_name( (Il2CppClass *) (m_Object.m_pClass), m_pMemberName);
